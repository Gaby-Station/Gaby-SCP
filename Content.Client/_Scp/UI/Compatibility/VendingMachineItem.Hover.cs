...
/// <summary>
/// Partial class for VendingMachineItem that handles hover-related styling.
/// This is needed because CSS ParentOf selectors don't re-evaluate when parent pseudo-class changes.
/// </summary>
public sealed partial class VendingMachineItem
{
    ...
    private void OnParentMouseEntered(GUIMouseHoverEventArgs args)
    {
        ...
        {
            NameLabel.FontColorOverride = NormalTextColor;
            return;
        }

        // When mouse enters, always show dark text (background will be white)
        NameLabel.FontColorOverride = HoveredTextColor;
    }
    ...
    private void OnParentMouseExited(GUIMouseHoverEventArgs args)
    {
        ...
        if (_parentButton is BaseButton button)
        {
            ...
            NameLabel.FontColorOverride = willBePressed ? HoveredTextColor : NormalTextColor;
        }
    }
    ...
    private void UpdateTextColor()
    {
        ...
        if (_parentButton is BaseButton button)
        {
            ...
            NameLabel.FontColorOverride = needsDarkText ? HoveredTextColor : NormalTextColor;
        }
        else
        {
            NameLabel.FontColorOverride = NormalTextColor;
