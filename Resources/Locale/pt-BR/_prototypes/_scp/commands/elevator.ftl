...
elevator-manage-floors-move-help  = Para a ação 'mover', especifique o nome e a direção do andar: { $command } <elevator_id> move <floor_name> <direção>\nDireções: para cima, para baixo ou número de índice (baseado em 0)
