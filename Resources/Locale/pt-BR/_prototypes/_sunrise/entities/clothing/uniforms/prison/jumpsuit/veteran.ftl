...
ent-ClothingUniformJumpsuitPrisonChefVeteran  = Um uniforme feito sob medida para especialistas culinários experientes, com a orgulhosa marca de inúmeros pratos perfeitamente preparados e a sabedoria de anos passados ​​dominando a cozinha da prisão.
...
ent-ClothingUniformJumpsuitPrisonTraineeVeteran  = Uniformes de treinamento experientes para mentores experientes que guiaram inúmeros recrutas em seus primeiros dias desafiadores, com sua sabedoria adquirida ao longo de anos moldando a próxima geração de guardas.
