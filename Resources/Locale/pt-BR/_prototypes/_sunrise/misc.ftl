ent-MobGorillaRampaging  = Um gorila fora de controle. Correr!
    .desc  = Um gorila fora de controle. Correr!

ent-MachineArtifactCrusherXenoborg  = É melhor não enfiar a cabeça aí...
    .desc  = É melhor não enfiar a cabeça aí...

ent-WeaponSubMachineGunBriefcase  = Útil para carregar coisas nas mãos.
...
ent-CableDet  = Espaguete para quem odeia paredes.
