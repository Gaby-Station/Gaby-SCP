ent-Holopad  = Dispositivo de chão para projeção de imagens holográficas.
...
ent-HolopadUnlimitedRange  = Um dispositivo montado no chão para projetar imagens holográficas em dispositivos semelhantes localizados a distâncias extremas.
