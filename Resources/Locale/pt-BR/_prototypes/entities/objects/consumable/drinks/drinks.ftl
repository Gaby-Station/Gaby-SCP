...
ent-DrinkGlass  = vidro cupê
    .desc  = vidro cupê
ent-DrinkGlassCoupeShaped  = Um copo cupê clássico com haste fina, um símbolo de rótulos de "não derrubar" em caixas por toda a galáxia.
...
ent-DrinkShakeEmpty  = copo de coquetel vazio
    .desc  = { ent-DrinkGlassBase.desc }
ent-DrinkShakeMeat  = coquetel robótico
    .desc  = { ent-DrinkGlassBase.desc }
