...
messenger-no-members  = Adicionar
...
messenger-add-user-to-group-title  = Adicionar participante a { $groupName }
messenger-no-users-available  = Procurar:
...
messenger-system-user-removed-by  = Usado recentemente
