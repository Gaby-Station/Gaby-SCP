ui-vote-initiator-server  = Mantenha-se aberto

## Default.Votes

ui-vote-restart-title  = A votação para reiniciar a rodada foi bem-sucedida.
ui-vote-restart-succeeded  = A votação para reiniciar a rodada foi bem-sucedida.
ui-vote-restart-failed  = Votação de reinício da rodada rejeitada: Um mínimo de { TOSTRING($ratio, "P0") }% dos jogadores devem ser fantasmas para acionar uma votação de reinício. Não há jogadores fantasmas suficientes no momento.
...
ui-vote-restart-abstain  = Próximo modo de jogo
...
ui-vote-secret-map  = Serviço de segurança
