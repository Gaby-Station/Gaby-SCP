...
cmd-grant_connect_bypass-arg-user  = Duração inválida '__PH0__'
cmd-grant_connect_bypass-arg-duration  = [длительность в минутах]
cmd-grant_connect_bypass-invalid-args  = Duração inválida '__PH0__'
cmd-grant_connect_bypass-unknown-user  = Duração inválida '{ $user }'
cmd-grant_connect_bypass-invalid-duration  = Permissão de desvio adicionada com sucesso para o usuário '{ $duration }'
