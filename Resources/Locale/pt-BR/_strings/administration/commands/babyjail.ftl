cmd-babyjail-desc  = Uso: babyjail
cmd-babyjail-help  = Uso: babyjail
babyjail-command-enabled  = O modo jardim de infância está desativado.
...
babyjail-command-max-account-age-is  = A idade máxima da conta para o modo "jardim de infância" é definida como { $minutes } minutos.
...
cmd-babyjail_max_overall_minutes-help  = Uso: babyjail_max_overall_minutos <minutos>
