...
admin-notes-expires-never  = ID da rodada: __PH0__
...
admin-notes-hide  = Última alteração de __PH0__ para __PH1__
...
admin-note-editor-type-role-ban  = O papel da proibição
...
admin-note-editor-expiry-label-expired  = Desejo
...
admin-note-button-hours  = Tempos
admin-note-button-days  = Dias
admin-note-button-weeks  = Meses
