...
reagent-desc-cola  = Um favorito entre os membros mais jovens da tripulação.
reagent-name-shirley-temple  = Shirley Templo
reagent-desc-shirley-temple  = Picada do Genestealer
...
reagent-name-dr-gibb  = Vermelho é
reagent-desc-dr-gibb  = Uma deliciosa mistura de 42 sabores diferentes.
reagent-name-energy-drink  = Uma dose de energia! A Fundação não é responsável se você cultivar apêndices de aves.
...
reagent-name-lemon-lime  = Snyder
...
reagent-name-root-beer  = classificação
...
reagent-name-fourteen-loko  = quatorze loco
