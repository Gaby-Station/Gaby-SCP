# Способности
changeling-biomass-deficit  = Não pode ser usado em formato menor!
changeling-chemicals-deficit  = Não pode ser usado em formato menor!
...
changeling-sting-fail-simplemob  = Não é possível extrair DNA
