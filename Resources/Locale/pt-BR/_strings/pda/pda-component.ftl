...
# For the PDA screen
comp-pda-ui  = Proprietário: [color=white]{ $owner }[/color]
comp-pda-ui-blank  = EU IA:
comp-pda-ui-owner  = Proprietário: [color=white]{ $actualOwnerName }[/color]
comp-pda-io-program-list-button  = Nenhum programa disponível
comp-pda-io-settings-button  = Regras
...
pda-bound-user-interface-show-uplink-description  = Obtenha acesso ao seu uplink
