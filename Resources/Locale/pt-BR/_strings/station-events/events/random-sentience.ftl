...
random-sentience-event-data-1  = nossa onipotência
random-sentience-event-data-2  = tráfego de comunicação da sua estação
random-sentience-event-data-3  = tráfego de comunicação da sua estação
...
random-sentience-event-strength-8  = II
