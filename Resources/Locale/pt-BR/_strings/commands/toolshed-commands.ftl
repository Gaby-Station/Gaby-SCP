command-description-visualize  = Executa um verbo nas entidades especificadas com o usuário especificado.
command-description-runverbas  = Retorna direitos administrativos para o comando especificado, se houver.
command-description-acmd-perms  = Verifica se o player especificado pode chamar o comando especificado.
command-description-acmd-caninvoke  = Retorna todas as posições na estação.
...
command-description-marked  = Retorna o valor de $marked como uma lista de entidades.
