# Announce
icarus-announce-sender  = CARREGAMENTO NÃO AUTORIZADO DO CARTÃO CHAVE DETECTADO. TODAS AS CHAVES CARREGADAS!
...
# UI
icarus-ui-window-title  = Tempo antes do disparo:
icarus-ui-fire-button  = Fogo
icarus-ui-timer-label  = Tempo antes do disparo:
icarus-ui-cooldown-label  = Recarregar:
