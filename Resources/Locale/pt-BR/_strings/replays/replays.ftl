...
replay-loading  = Processamento de arquivos
replay-loading-reading  = Geração de Entidade
replay-loading-processing  = Geração de Entidade
replay-loading-spawning  = Inicializando Entidades
