...
ui-options-scp-graphics  = Gerenciamento
ui-options-scp-audio  = Áudio
ui-options-scp-game  = Passe o mouse sobre uma configuração para ver uma dica sobre a ação da configuração.
ui-options-tab-hover-to-see-details  = Essas configurações afetam diretamente o desempenho do jogo.
...
ui-options-grain-toggle-overlay  = Força do shader de grãos
...
ui-options-grain-strength  = Força do shader de grãos
