...
alert-desc-scp096-face-rage  = { alert-desc-scp096-face-base }
    ...
    ​[color = vermelho]consistindo apenas em seus gritos.[/color]

alert-desc-scp096-face-heating-up  = { alert-desc-scp096-face-base }
    > ЛИЦА ГОРЯТ В МОЕЙ ПАМЯТИ <
    Их черты впёкаются в мою плоть! Каждый их взгляд - это гвоздь в гроб моего покоя! [color = vermelho]consistindo apenas em seus gritos.[/color]
