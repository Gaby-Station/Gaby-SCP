...
connecting-reconnect  = Reiniciar
connecting-copy  = Reiniciar
connecting-redial  = Reiniciar
connecting-redial-wait  = Conectando ao servidor...
...
connecting-state-ResolvingHost  = Estabelecendo uma conexão
